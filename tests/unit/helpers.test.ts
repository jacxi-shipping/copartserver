...
test('search helpers build stable where clauses', () => {
  assert.deepEqual(buildTextSearchWhere('toyota'), {
    OR: [
      ...
      { modelGroup: { contains: 'toyota', mode: 'insensitive' } },
      { modelDetail: { contains: 'toyota', mode: 'insensitive' } },
      { trim: { contains: 'toyota', mode: 'insensitive' } },
      { bodyStyle: { contains: 'toyota', mode: 'insensitive' } },
      { vehicleType: { contains: 'toyota', mode: 'insensitive' } },
      { color: { contains: 'toyota', mode: 'insensitive' } },
      { damageDescription: { contains: 'toyota', mode: 'insensitive' } },
      { secondaryDamage: { contains: 'toyota', mode: 'insensitive' } },
      { engine: { contains: 'toyota', mode: 'insensitive' } },
      { drive: { contains: 'toyota', mode: 'insensitive' } },
      { transmission: { contains: 'toyota', mode: 'insensitive' } },
      { fuelType: { contains: 'toyota', mode: 'insensitive' } },
      { runsDrives: { contains: 'toyota', mode: 'insensitive' } },
      { saleStatus: { contains: 'toyota', mode: 'insensitive' } },
      { locationCity: { contains: 'toyota', mode: 'insensitive' } },
      { locationState: { contains: 'toyota', mode: 'insensitive' } },
      { yardName: { contains: 'toyota', mode: 'insensitive' } },
      { sellerName: { contains: 'toyota', mode: 'insensitive' } },
